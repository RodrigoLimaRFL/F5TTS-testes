...
set "CKPT=C:\Users\guico\Documents\code\F5TTS-testes\automatic\model_last.pt"
...
set "OUTDIR=C:\Users\guico\Documents\code\F5TTS-testes\automatic\audios\SP_DID_234"
