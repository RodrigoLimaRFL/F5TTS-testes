...
- Pegue 'path' e 'text' de NURC-SP_ENTOA_TTS/prosodic/train.csv e crie um arquivo NURC-SP_ENTOA_TTS/prosodic/metadata.csv com os campos 'audio_file' e 'text' e separador '|'
- Compile o container
```
